...
void main()
{
    ...
    directionalLightDirection[0] = vec3(1, 0, 0);
    ...
    vec3 viewPosition = normalize( vViewPosition );
        ...
        for( int i = 0; i < MAX_DIR_LIGHTS; i ++ ) {
           ...
           // #ifdef PHYSICALLY_BASED_SHADING
                ...
                vec3 schlick = specular + vec3( 1.0 - specular ) * pow( dot( dirVector, dirHalfVector ), 2.0 );
                dirSpecular += schlick * directionalLightColor[ i ] * dirSpecularWeight * dirDiffuseWeight*0.4;
    ...
    vec3 scaledPos = vec3( 0.0,0.0,0.0) + surface(mPosition*0.004);
    vec3 DiffuseColour = mix(totalDiffuse*DiffuseColour1,totalDiffuse*DiffuseColour2,scaledPos);
